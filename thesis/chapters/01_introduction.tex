...
\begin{description}[noextralabelsep]
	...
	\item[\cref{cha:architecture}] describes the high-level architecture of the semantic exploration kernel and explains its fundamental components: \emph{artifact boards} and \emph{semantic conversation interfaces}.
