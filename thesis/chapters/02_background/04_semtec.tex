...
\begin{figure}
	\centering
	%\includegraphics[width=\textwidth]{04_semtec/transformer.png}
	\makebox[\textwidth][c]{\includegraphics[width=\textwidth+6cm]{04_semtec/transformer.png}}
	% todo: kreuzende linien überbrücken
	% todo: is this layout ok? recheck with binding correction!
...
\begin{description}
	...
	This often includes semantic retrieval methods~(\cref{sec:background/semtec/retrieval}).
