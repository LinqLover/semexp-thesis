...
Similarly to code completion tools, visual programming editors such as \name{Etoys} or \name{Scratch}~\cite{resnick2009scratch} offer \emph{palettes} through which programmers can list and apply different relevant methods for their programs.
