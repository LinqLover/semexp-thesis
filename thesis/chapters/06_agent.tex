...
In our prototype, we use OpenAI's LLM \gptfouro\footnote{Used in the version \code{gpt-4o-2024-05-13}.}, which ranks among the state-of-the-art models for our required capabilities such as problem solving and code writing at the time of writing~\cite{openai2024gpt4}.
...
\footnote{We provide a full conversation including all system prompts and function calls for the example from \cref{fig:application/conversation/text} in \cref{apx:conversation}.} % in the GitHub repository (\url{https://github.com/hpi-swa-lab/SemanticSqueak/blob/11637e5/assets/Text.conversation})
