...
\footnote{We provide the full conversation including all system prompts and function calls for the example from \cref{fig:application/text/text} in the GitHub repository (\url{https://github.com/hpi-swa-lab/SemanticSqueak/blob/11637e5/assets/Text.conversation}).} % TODO: make sure this figure exists! link to github repos somewhere else too!
