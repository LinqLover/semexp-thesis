...
\begin{center}
	\begin{tblr}{
		...
		\includegraphics[width=\linewidth]{01_suggestions/workspace_start.png} & % TODO: improve resolution, maybe scale down workspace
		\includegraphics[width=\linewidth]{01_suggestions/app_start.png} % TODO: improve resolution
	\end{tblr}
	% TODO: is it okay to leave out SOME captions?
\end{center}
...
\begin{center}
	\includegraphics[height=30\baselineskip]{01_suggestions/suggestion_space.png} % TODO: improve resolution, prepend Morph>> to layoutPolicy:, one example should use Color gray, LESS details on border styles!
...
\begin{center}
	\includegraphics[width=\linewidth]{01_suggestions/semantic_autocompletion.png} % TODO: reduce width of completion panes (+ no preview in header of detail pane), improve resolution
...
\begin{center}
	\begin{tblr}{
		...
		\includegraphics[width=\linewidth,valign=c]{01_suggestions/workspace_final.png} & % TODO: improve resolution, slightly shrink workspace horizontally?
		\includegraphics[width=\linewidth,valign=c]{01_suggestions/app_final.png} % TODO: improve resolution
	\end{tblr}
\end{center}
