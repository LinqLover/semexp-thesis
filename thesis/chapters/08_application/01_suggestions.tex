...
\begin{minipage}{\textwidth}
	\centering
	\includegraphics[height=28\baselineskip]{01_suggestions/suggestion_space.png} % TODO screenshot: improve resolution, prepend Morph>> to layoutPolicy:, one example should use Color gray, LESS details on border styles!
