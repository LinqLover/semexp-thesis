...
\begin{figure}
	...
	\caption[The high-level architecture of the \emph{semantic exploration kernel} and its environment.]{
		...
		\CircledInverted{Numbers} reference the chapter, appendix, or section in this thesis that further describes a component.
	}
