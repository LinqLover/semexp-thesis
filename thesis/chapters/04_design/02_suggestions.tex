...
In our example, a fourth strategy could extract and suggest popular message sends from similar methods. % todo: i.e., correlated names - use this term here?
...
\begin{example}
	% todo: update names with suggestions chapter
