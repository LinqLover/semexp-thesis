...
\begin{figure}
	\centering
	\begin{subfigure}[t]{0.55\dimexpr\textwidth-1em\relax}
        \centering
    ...
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\dimexpr\textwidth-1em\relax}
        \centering
        ...
        \label{fig:semtex/tools/piricing/expense_watchers/completion_metrics}
    \end{subfigure}
