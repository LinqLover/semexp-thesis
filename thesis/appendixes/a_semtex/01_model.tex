...
To compute embeddings, the corpus is provided with a \code{EmbeddingModel} (which may be implemented by different providers, see \cref{sec:semtex/providers}) and a \code{EmbeddingConfig} for controlling the embedding properties such as the length of embedding vectors.
...
%		ranking \printit{a SearchResultRanking(\allowbreak\#SemanticCorpus->0.45 \#SemanticAgent->0.433 \#SemanticAgentParser->0.412 \#WordNet->0.412 \#SemanticMathAgent->0.402)}
...
%		\printit{a SearchResultRanking(\allowbreak\#SemanticCorpus->0.533 \#SemanticHelpSearchTopic->0.442 \#SemanticText->0.385 \#SemanticAgentParser->0.364 \#SemanticMathAgent->0.338)}
%	\end{multicode}
%\end{example}
...
\begin{example}[5]
	...
	\begin{multicode}
		...
		ranking := results top: 5. \newline
		ranking \printit{a SearchResultRanking(\allowbreak\#SemanticCorpus->0.533 \#SemanticHelpSearchTopic->0.442 \#SemanticText->0.385 \#SemanticAgentParser->0.364 \#SemanticMathAgent->0.338)}
		% todo: introduce printit notation anywhere?
	\end{multicode}
\end{example}
