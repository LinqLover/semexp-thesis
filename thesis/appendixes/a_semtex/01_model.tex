...
The \code{SemanticAgent} class provides a custom DSL (domain-specific language) for specifying function signatures with its arguments, their constraints (such as argument types or optional arguments), and their descriptions through method pragmas.
